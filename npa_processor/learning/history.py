"""РЎРѕС…СЂР°РЅРµРЅРёРµ РїРѕР»РЅРѕР№ РёСЃС‚РѕСЂРёРё документа РїРѕСЃР»Рµ РІРЅРµСЃРµРЅРёСЏ РёР·РјРµРЅРµРЅРёР№.

РњРѕРґСѓР»СЊ С„РёРєСЃРёСЂСѓРµС‚ СЃРЅРёРјРєРё (snapshot) СЃРѕСЃС‚РѕСЏРЅРёСЏ документа РїРѕСЃР»Рµ РєР°Р¶РґРѕРіРѕ
РїСЂРёРјРµРЅСЏРµРјРѕРіРѕ изменения Рё РїРѕСЃР»Рµ С„РёРЅР°Р»СЊРЅРѕР№ РїРµСЂРµСЃС‚СЂРѕР№РєРё. Р­С‚Рѕ РіР°СЂР°РЅС‚РёСЂСѓРµС‚,
С‡С‚Рѕ:
...
* Р»СЋР±РѕРµ РїСЂРѕРјРµР¶СѓС‚РѕС‡РЅРѕРµ изменение РјРѕР¶РЅРѕ РІРёР·СѓР°Р»РёР·РёСЂРѕРІР°С‚СЊ / РѕС‚РєР°С‚РёС‚СЊ;
* РїРѕР»РЅР°СЏ история С‚СЂР°РЅСЃС„РѕСЂРјР°С†РёР№ СЃРѕС…СЂР°РЅСЏРµС‚СЃСЏ РІ ``07_learning/history/``.

РљР°Р¶РґС‹Р№ СЃРЅРёРјРѕРє вЂ” СЌС‚Рѕ СЃР°РјРѕСЃС‚РѕСЏС‚РµР»СЊРЅС‹Р№ JSON-файл СЃ РјРµС‚Р°РґР°РЅРЅС‹РјРё Рѕ С‚РѕРј,
РєР°РєРѕРµ изменение (change_index) Рё СЃ РєР°РєРёРј СЂРµР·СѓР»СЊС‚Р°С‚РѕРј (applied / error)
...
class DocumentHistory:
    """РЈРїСЂР°РІР»РµРЅРёРµ РІРµСЂСЃРёРѕРЅРЅС‹РјРё СЃРЅРёРјРєР°РјРё документа РІ СЂР°РјРєР°С… РѕРґРЅРѕРіРѕ Р·Р°РїСѓСЃРєР°."""
    ...
    def snapshot(self, label, data, metadata=None):
        """РЎРѕС…СЂР°РЅРёС‚СЊ СЃРЅРёРјРѕРє документа СЃ РјРµС‚Р°РґР°РЅРЅС‹РјРё.
        ...
        label : str
            ...
            ``after_rebuild``).
        data : dict
            РЎРѕСЃС‚РѕСЏРЅРёРµ документа.
        metadata : dict | None
            Р”РѕРїРѕР»РЅРёС‚РµР»СЊРЅС‹Рµ СЃРІРµРґРµРЅРёСЏ (РЅРѕРјРµСЂ изменения, structural_element,
            С‚РёРї, РїСЂРёРјРµРЅРµРЅРѕ / РЅРµ РїСЂРёРјРµРЅРµРЅРѕ, сообщение РѕР± РѕС€РёР±РєРµ Рё С‚.Рї.).
        """
        self._counter += 1
        idx = self._counter
