"""РЎРёСЃС‚РµРјР° РІРµСЂРёС„РёРєР°С†РёРё СЂРµР·СѓР»СЊС‚Р°С‚РѕРІ СЃР»РёСЏРЅРёСЏ РќРџРђ.

РџСЂРѕРІРµСЂСЏРµС‚ С†РµР»РѕСЃС‚РЅРѕСЃС‚СЊ СЃС‚СЂСѓРєС‚СѓСЂС‹ JSON (СЃРѕРѕС‚РІРµС‚СЃС‚РІРёРµ РѕРїРёСЃР°РЅРёСЋ СЃС…РµРјС‹ РІ
``02_json_schema_docs/``) Рё СЃРІРµСЂСЏРµС‚ РїСЂРёРјРµРЅС‘РЅРЅС‹Рµ РёР·РјРµРЅРµРЅРёСЏ СЃ РѕР¶РёРґР°РµРјС‹РјРё
СЂРµР·СѓР»СЊС‚Р°С‚Р°РјРё РёР· РѕС‚РІРµС‚РѕРІ СЌС‚Р°РїРѕРІ (``04_stage_answers/``). Р›СЋР±Р°СЏ РѕРїР»РѕС€РЅРѕСЃС‚СЊ
РІРѕР·РІСЂР°С‰Р°РµС‚СЃСЏ РєР°Рє СЃС‚СЂСѓРєС‚СѓСЂРёСЂРѕРІР°РЅРЅР°СЏ РѕС€РёР±РєР° СЃ РєР°С‚РµРіРѕСЂРёРµР№, С‡С‚Рѕ РїРѕР·РІРѕР»СЏРµС‚
СЃР°РјРѕРѕР±СѓС‡Р°СЋС‰РµРјСѓСЃСЏ СЃРёСЃС‚РµРјРµ РєР»Р°СЃСЃРёС„РёС†РёСЂРѕРІР°С‚СЊ Рё РёСЃРїСЂР°РІР»СЏС‚СЊ РµС‘.
"""
...
class VerificationError:
    """РћРґРёРЅРѕС‡РЅР°СЏ РѕС€РёР±РєР° РІРµСЂРёС„РёРєР°С†РёРё СЃ РјРµС‚Р°РґР°РЅРЅС‹РјРё РґР»СЏ СЃР°РјРѕРѕР±СѓС‡РµРЅРёСЏ."""
...
class VerificationResult:
    """РђРіСЂРµРіРёСЂРѕРІР°РЅРЅС‹Р№ СЂРµР·СѓР»СЊС‚Р°С‚ РїРѕР»РЅРѕР№ РІРµСЂРёС„РёРєР°С†РёРё."""
...
class StructureVerifier:
    """Р’РµСЂРёС„РёРєР°С‚РѕСЂ С†РµР»РѕСЃС‚РЅРѕСЃС‚Рё СЃС‚СЂСѓРєС‚СѓСЂС‹ Рё СЃРѕРѕС‚РІРµС‚СЃС‚РІРёСЏ РѕР¶РёРґР°РµРјС‹Рј РёР·РјРµРЅРµРЅРёСЏРј.

    РџСЂР°РІРёР»Р° РІР·СЏС‚С‹ РёР· ``02_json_schema_docs/npa_json_schema.md`` Рё
    ``02_json_schema_docs/element_hierarchy_rules.md``, Р° С‚Р°РєР¶Рµ РёР· СЂР°Р·РґРµР»Р° 6
    ``AGENT_INSTRUCTION.md`` (РџР РћР’Р•Р РљРђ РЎРўР РЈРљРўРЈР Р« / РЎРЎР«Р›РћРљ / Р”РђРў / РР—РњР•РќР•РќРР™).
    """
    ...
    def verify(self, data, changes=None, source_data=None, change_log=None):
        """Р—Р°РїСѓСЃС‚РёС‚СЊ РїРѕР»РЅСѓСЋ РІРµСЂРёС„РёРєР°С†РёСЋ.

        Parameters
        ----------
        data : dict
            Р РµР·СѓР»СЊС‚РёСЂСѓСЋС‰РёР№ РґРѕРєСѓРјРµРЅС‚ (target NPA РїРѕСЃР»Рµ РїСЂРёРјРµРЅРµРЅРёСЏ РёР·РјРµРЅРµРЅРёР№).
        changes : list[dict] | None
            РЎРїРёСЃРѕРє РёР·РјРµРЅРµРЅРёР№ (РёР· СЌС‚Р°РїРѕРІ 1-3), РєРѕС‚РѕСЂС‹Рµ РґРѕР»Р¶РЅС‹
            Р±С‹С‚СЊ РїСЂРёРјРµРЅРµРЅС‹.
        source_data : dict | None
            РР·РјРµРЅСЏСЋС‰РёР№ РќРџРђ (РґР»СЏ РїСЂРѕРІРµСЂРєРё С„РѕСЂРјР°С‚Р° ``modified_by_id``).
        change_log : list[dict] | None
            Р–СѓСЂРЅР°Р» РїСЂРёРјРµРЅС‘РЅРЅС‹С… РёР·РјРµРЅРµРЅРёР№ {structural_element, type, applied, error}
            вЂ” РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ СЃРІРµСЂРєРё СЃ РѕР¶РёРґР°РµРјС‹РјРё СЂРµР·СѓР»СЊС‚Р°С‚Р°РјРё.
        """
    ...
    # ------------------------------------------------------------------
    # 1. РЈРЅРёРєР°Р»СЊРЅРѕСЃС‚СЊ item_id
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 2. Р”РѕРїСѓСЃС‚РёРјС‹Рµ item_type
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 3. РљРѕСЂСЂРµРєС‚РЅРѕСЃС‚СЊ item_level (С…РѕРґ РїРѕ РґРµСЂРµРІСѓ СЃ СѓС‡С‘С‚РѕРј РіР»СѓР±РёРЅС‹)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 4. Р¦РµР»РѕСЃС‚РЅРѕСЃС‚СЊ РґРµСЂРµРІР°: child_ref в†’ СЃСѓС‰РµСЃС‚РІСѓСЋС‰РёР№ item_id;
    #    РІСЃРµ РґРµС‚Рё РёРјРµСЋС‚ child_ref РІ body СЂРѕРґРёС‚РµР»СЏ
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 5. Р РµРІРёР·РёРё: Р°РєС‚РёРІРЅРѕСЃС‚СЊ, valid_from / valid_to, РЅРµРїСЂРµСЂС‹РІРЅРѕСЃС‚СЊ
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 6. Р¤РѕСЂРјР°С‚ РєРѕСЂРЅРµРІС‹С… РґР°С‚
    # ------------------------------------------------------------------
