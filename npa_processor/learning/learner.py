"""РЎР°РјРѕРѕР±СѓС‡Р°СЋС‰РёР№СЃСЏ РґРІРёР¶РѕРє РґР»СЏ NPA JSON Agent.

РњРµС…Р°РЅРёР·Рј СЃР°РјРѕРѕР±СѓС‡РµРЅРёСЏ СЂРµР°Р»РёР·СѓРµС‚ **Р·Р°РјРєРЅСѓС‚С‹Р№ С†РёРєР» РѕР±СЂР°С‚РЅРѕР№ СЃРІСЏР·Рё**:

1. **Р—Р°РїРёСЃСЊ СЂРµР·СѓР»СЊС‚Р°С‚РѕРІ** вЂ” РїРѕСЃР»Рµ РєР°Р¶РґРѕРіРѕ Р·Р°РїСѓСЃРєР° РїР°Р№РїР»Р°Р№РЅР° СЃРѕС…СЂР°РЅСЏСЋС‚СЃСЏ
   РґРµС‚Р°Р»СЊРЅС‹Рµ СЂРµР·СѓР»СЊС‚Р°С‚С‹ РІРµСЂРёС„РёРєР°С†РёРё, РёСЃС…РѕРґС‹ РєР°Р¶РґРѕРіРѕ РёР·РјРµРЅРµРЅРёСЏ Рё СЃРѕРѕР±С‰РµРЅРёСЏ
   РѕР± РѕС€РёР±РєР°С… (РЅРµ С‚РѕР»СЊРєРѕ СЃС‡С‘С‚С‡РёРєРё, РєР°Рє СЂР°РЅСЊС€Рµ).
2. **РљРѕРЅСЃСѓР»СЊС‚Р°С†РёСЏ РїРµСЂРµРґ РїСЂРёРјРµРЅРµРЅРёРµРј** вЂ” РїРµСЂРµРґ РїСЂРёРјРµРЅРµРЅРёРµРј РёР·РјРµРЅРµРЅРёР№ Р°РіРµРЅС‚
   Р·Р°РїСЂР°С€РёРІР°РµС‚ РїСЂРѕРІРµСЂРµРЅРЅС‹Рµ РјР°РїРїРёРЅРіРё (``get_reliable_mapping``) Рё
   СЂРµРєРѕРјРµРЅРґР°С†РёРё РїРѕ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёСЋ РїСЂРё РѕС€РёР±РєРµ СЃРІСЏР·Р°РЅРЅРѕР№ СЃС‚СЂСѓРєС‚СѓСЂС‹
   (``get_suggestions_for_element``).
3. **РђРЅР°Р»РёР· РїСЂРѕРІР°Р»РѕРІ** вЂ” ``get_failure_patterns`` РіСЂСѓРїРїРёСЂСѓРµС‚ РёСЃС‚РѕСЂРёС‡РµСЃРєРёРµ
   РѕС€РёР±РєРё РїРѕ РєР°С‚РµРіРѕСЂРёРё Рё РїСЂРµРґР»Р°РіР°РµС‚ Р°Р»РіРѕСЂРёС‚РјРёС‡РµСЃРєРёРµ СѓР»СѓС‡С€РµРЅРёСЏ.
4. **Р—Р°РїРѕРјРёРЅР°РЅРёРµ СѓСЃРїРµС€РЅС‹С… РѕР±С…РѕРґРЅС‹С… РїСѓС‚РµР№** вЂ” ``record_recovery`` С„РёРєСЃРёСЂСѓРµС‚,
   РєР°РєРѕРµ РёРјРµРЅРЅРѕ РёСЃРїСЂР°РІР»РµРЅРёРµ СЃСЂР°Р±РѕС‚Р°Р»Рѕ РґР»СЏ РєРѕРЅРєСЂРµС‚РЅРѕРіРѕ СЃС†РµРЅР°СЂРёСЏ.

Р›СЋР±Р°СЏ РѕРїР»РѕС€РЅРѕСЃС‚СЊ РІРµРґС‘С‚ Рє РёР·РјРµРЅРµРЅРёСЋ Р°Р»РіРѕСЂРёС‚РјР°: СЂРµР·СѓР»СЊС‚Р°С‚С‹ РІРµСЂРёС„РёРєР°С†РёРё
РїСЂРµРІСЂР°С‰Р°СЋС‚СЃСЏ РІ РєРѕРЅРєСЂРµС‚РЅС‹Рµ СЂРµРєРѕРјРµРЅРґР°С†РёРё, РєРѕС‚РѕСЂС‹Рµ РёСЃРїРѕР»СЊР·СѓСЋС‚СЃСЏ РІ
РїРѕСЃР»РµРґСѓСЋС‰РёС… Р·Р°РїСѓСЃРєР°С….
"""
...
class LearningEngine:
    """Р¦РµРЅС‚СЂР°Р»СЊРЅС‹Р№ РґРІРёР¶РѕРє СЃР°РјРѕРѕР±СѓС‡РµРЅРёСЏ.
    ...
    def record_detailed_run(self, source_npa_id, target_npa_id, changes_applied,
        ...
        "applied", "error"}`` РґР»СЏ РєР°Р¶РґРѕРіРѕ РёР·РјРµРЅРµРЅРёСЏ.
    ...
    def record_mapping(self, structural_element, item_id, success, source_context='',
        ...
        РўРµРїРµСЂСЊ Р·Р°РїРёСЃСЊ РґРµР»Р°РµС‚СЃСЏ **РїРѕСЃР»Рµ** С„Р°РєС‚РёС‡РµСЃРєРѕРіРѕ РїСЂРёРјРµРЅРµРЅРёСЏ РёР·РјРµРЅРµРЅРёСЏ,
        РїРѕСЌС‚РѕРјСѓ success РѕС‚СЂР°Р¶Р°РµС‚ РЅРµ РїСЂРѕСЃС‚Рѕ РїРѕРёСЃРє СЌР»РµРјРµРЅС‚Р°, Р° РєРѕСЂСЂРµРєС‚РЅРѕСЃС‚СЊ
        РІСЃРµРіРѕ РїСЂРёРјРµРЅРµРЅРёСЏ РёР·РјРµРЅРµРЅРёСЏ Рє СЌС‚РѕРјСѓ element_id.
        """
    ...
    def get_prompt_suggestion(self, stage):
        ...
        Р•СЃР»Рё РєРѕСЌС„С„РёС†РёРµРЅС‚ СѓСЃРїРµС…Р° < 0.5, РїСЂРµРґР»Р°РіР°РµС‚ СѓРІРµР»РёС‡РёС‚СЊ temperature
        ...
        if score < 0.5:
            return {
                ...
                'suggestion': (
                    ...
                    "СѓРІРµР»РёС‡РёС‚СЊ temperature РґРѕ 0.3-0.7, РґРѕР±Р°РІРёС‚СЊ РєРѕРЅС‚СЂР°РІР°СЂРёР°РЅС‚РЅС‹Рµ "
                    "РїСЂРёРјРµСЂС‹ РІ prompt, РґРѕР±Р°РІРёС‚СЊ РёРЅСЃС‚СЂСѓРєС†РёСЋ Рѕ СЃС‚СЂРѕРіРѕРј JSON-С„РѕСЂРјР°С‚Рµ."
                ),
            }
        return {
            'stage': stage,
            'success_rate': score,
            'total': total,
            'suggestion': 'РџСЂРѕРјРїС‚ СЂР°Р±РѕС‚Р°РµС‚ СЃС‚Р°Р±РёР»СЊРЅРѕ, РёР·РјРµРЅРµРЅРёСЏ РЅРµ С‚СЂРµР±СѓСЋС‚СЃСЏ.',
        }
    ...
    def record_change_outcome(self, structural_element, change_type, applied,
        ...
        """Р—Р°РїРёСЃР°С‚СЊ РёСЃС…РѕРґ РєРѕРЅРєСЂРµС‚РЅРѕРіРѕ РёР·РјРµРЅРµРЅРёСЏ (РїРѕСЃР»Рµ РїСЂРёРјРµРЅРµРЅРёСЏ + РІРµСЂРёС„РёРєР°С†РёРё)."""
        entry = {
            'timestamp': datetime.now().isoformat(),
    ...
    def get_recovery_suggestion(self, structural_element, error_category):
        """Р’РµСЂРЅСѓС‚СЊ РїСЂРѕРІРµСЂРµРЅРЅРѕРµ РѕР±С…РѕРґРЅРѕРµ СЂРµС€РµРЅРёРµ РґР»СЏ СЃРѕС‡РµС‚Р°РЅРёСЏ СЌР»РµРјРµРЅС‚+РѕС€РёР±РєР°."""
        key = f"{structural_element}||{error_category}"
        for entry in self._recovery_log:
            if entry.get('key') == key:
    ...
    def _suggest_for_pattern(structural_element, category, entries):
        ...
        if category in ('date_format_invalid', 'date_continuity'):
            suggestions.append('РџСЂРѕРІРµСЂРёС‚СЊ С„РѕСЂРјР°С‚ РґР°С‚ DD.MM.Y Рё РєРѕСЂСЂРµРєС‚РЅРѕСЃС‚СЊ valid_to = valid_from - 1 РґРµРЅСЊ')
        ...
        if category in ('change_not_applied', 'revision_missing'):
            ...
            if 'СЃС‚Р°С‚СЊ' in se:
                suggestions.append(
                    "РџСЂРѕРІРµСЂРёС‚СЊ РЅСѓРјРµСЂР°С†РёСЋ: СЃС‚Р°С‚СЊСЏ РјРѕР¶РµС‚ Р±С‹С‚СЊ РІР»РѕР¶РµРЅР° РІ РіР»Р°РІСѓ/СЂР°Р·РґРµР». "
                    "РџРѕРїСЂРѕР±РѕРІР°С‚СЊ РїРѕРёСЃРє С‡РµСЂРµР· find_element_in_chapters_or_sections."
                )
            elif 'С‡Р°СЃС‚СЊ' in se or 'РїСѓРЅРєС‚' in se or 'РїРѕРґРїСѓРЅРєС‚' in se:
                suggestions.append(
                    "РџСЂРѕРІРµСЂРёС‚СЊ РёРµСЂР°СЂС…РёСЋ: С‡Р°СЃС‚СЊ/РїСѓРЅРєС‚/РїРѕРґРїСѓРЅРєС‚ РјРѕР¶РµС‚ РЅР°С…РѕРґРёС‚СЊСЃСЏ РІРЅСѓС‚СЂРё "
                    "РґСЂСѓРіРѕРіРѕ СЂРѕРґРёС‚РµР»СЏ РїРѕСЃР»Рµ new_redaction СЃРѕСЃРµРґРЅРµР№ СЃС‚Р°С‚СЊРё."
                )
            else:
                suggestions.append(
                    "РџСЂРѕРІРµСЂРёС‚СЊ РїСѓС‚СЊ structural_element: РІРѕР·РјРѕР¶РЅРѕ, С‚СЂРµР±СѓРµС‚СЃСЏ "
    ...
    def get_suggestions_for_element(self, structural_element):
        """Р’РµСЂРЅСѓС‚СЊ РІСЃРµ РёР·РІРµСЃС‚РЅС‹Рµ СЂРµРєРѕРјРµРЅРґР°С†РёРё РґР»СЏ РєРѕРЅРєСЂРµС‚РЅРѕРіРѕ СЌР»РµРјРµРЅС‚Р°."""
        rec = self._mappings.get(structural_element)
        if not rec:
            return []
    ...
    # ------------------------------------------------------------------
    # 8. РҐР°СЂР°РєС‚РµСЂРЅС‹Рµ РїСЂРёРјРµСЂС‹ РѕС€РёР±РѕРє
    # ------------------------------------------------------------------
    def record_error_example(self, structural_element, error_category, error_message,
        ...
        structural_element : str
            РЎС‚СЂСѓРєС‚СѓСЂРЅС‹Р№ СЌР»РµРјРµРЅС‚, РЅР° РєРѕС‚РѕСЂРѕРј РїСЂРѕРёР·РѕС€Р»Р° РѕС€РёР±РєР°.
        error_category : str
            РљР°С‚РµРіРѕСЂРёСЏ РѕС€РёР±РєРё (СЃРј. ``VerificationError.category``).
        error_message : str
            РўРµРєСЃС‚ РѕС€РёР±РєРё.
        context : dict | None
            Р”РѕРїРѕР»РЅРёС‚РµР»СЊРЅС‹Р№ РєРѕРЅС‚РµРєСЃС‚ (С‚РёРї РёР·РјРµРЅРµРЅРёСЏ, РёРЅРґРµРєСЃ, РґР°РЅРЅС‹Рµ Рё С‚.Рї.).
        source_npa_id : str
    ...
    def get_error_examples(self, structural_element=None, error_category=None, limit=50):
        """Р’РµСЂРЅСѓС‚СЊ С…Р°СЂР°РєС‚РµСЂРЅС‹Рµ РїСЂРёРјРµСЂС‹ РѕС€РёР±РѕРє СЃ С„РёР»СЊС‚СЂР°С†РёРµР№."""
